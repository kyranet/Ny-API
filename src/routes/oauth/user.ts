...
import { DashboardClient, DashboardUser, encrypt, KlasaIncomingMessage, Route, RouteStore } from '../../lib/third_party/klasa-dashboard-hooks';
...
export default class extends Route {
	...
	public constructor(client: DashboardClient, store: RouteStore, file: string[], directory: string) {
		super(client, store, file, directory, { route: '/oauth/user', authenticated: true });
	}
